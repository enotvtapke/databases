...
-- Нужна возможность сортировки => btree. Чтобы не сортировать всех,
-- а только студентов в конкретной группе, первый столбец индекс это groupId
...
-- Чтобы искать максимум только в рамках заданного курса, но при этом
-- среди всех студентов, первый столбец courseId. btree потому что max
